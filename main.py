...
def campaign_analysis():
    ...
    gender = get_response_rate(data, 'Gender')
    age = get_response_rate(data, 'AgeGroup')
    last_quarter = get_response_rate(data, 'Purchase_Last_Quarter')
    products_purchased = get_response_rate(data, 'Products_Purchased_Group')
